...
# Generate random arrival intervals using Exponential distribution and service times
def x(ppp):
    print("Priemerny cas prichodu:", ppp)
    num_tasks = 10
    r = [max(2, int(np.random.exponential(scale=ppp))) for _ in range(num_tasks)]
